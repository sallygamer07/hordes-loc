export default [
  {
    ...
    description: {
      ...
      ko: '불에 탄 재료들을 꼬아서 함께 묶어 빈약한 보호 부적을 만들었다. 이렇게 단순한 부적을 만드는 것은 고대부터 흔한 생존 전술이었다.',
...

  {
    ...
    description: {
      ...
      ko: '늑대를 노예로 삼기 위한 고리는 두꺼운 가죽으로 만들어집니다. 그들 중 일부는 여전히 사슬 고리가 연결되어 있지만, 모든 늑대 고리는 튼튼합니다. 어떤 고리는 정신적인 보호로 가득 차 있습니다.',
...

  {
    ...
    description: {
      ...
      ko: '이 목걸이는 다양한 강력한 생물의 뼈 조각으로 구성되어 있습니다. 각각의 뼈 목걸이들은 뼈의 기원에 따라 보호가 다릅니다.',
...

  {
    ...
    description: {
      ...
      ko: '희생 된 사람들의 몸에 남겨진 무서운 늑대 인간 발톱은 신비한 기름을 바르고 명상을 통해 영적 불굴의 정신으로 불타 올랐습니다. 이 부적의 창시자는이 영적 보호가 언젠간 복수의 도구로 사용되기를 바랐습니다.',
...

  {
    ...
    description: {
      ...
      ko: '탈론이 발견되었을 때, 그것은 산 속에있는 신성한 새들의 선물로 간주되었습니다. 산 속 승려들은 전투 중에 침략자들로부터 스스로를 보호 할 수있는 영적인 부적을 만들기 위해 발톱을 사용했습니다.',
...

  {
    ...
    description: {
      ...
      ko: '산에서 채광한 이상한 조각들은 보호를 제공하고 두려움을 유발하기 위해 신비 주의자들에 의해 강화되어 부적으로 형성되었습니다.',
...

  {
    ...
    description: {
      ...
      ko: '신성한 오메가 상징을 보호하기 위한 수단으로 창조했다. 이 상징은 방어적인 선물로 주어진 공격을 막고 잠재적 인 종교 추종자에게 선물로 사용되었습니다.',
